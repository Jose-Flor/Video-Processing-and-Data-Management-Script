...
from Project1 import getData, cleanUp
...
def parse_args():
 ...
 # This is hwo we upload the information
...
def main():
 ...
 print("documents to server.")

 sys.exit()

 # project1 to clean up the location and frames
 ...
 writer = pandas.ExcelWriter("Project3.xlsx", engine="xlsxwriter")
 ...
 # dont look at this token >:(

 client = FrameioClient("my token would go here")

 project_id = "my poject id would go here"

 folder_id = "my folder id would go here"
